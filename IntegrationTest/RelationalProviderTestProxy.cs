...
using IntegrationTest.NorthwindSyncService;
using Microsoft.Synchronization;
using Microsoft.Synchronization.Data;

namespace IntegrationTest
{
    public class RelationalProviderTestProxy : KnowledgeSyncProvider, IDisposable
    {
        private ISyncService _proxy;
        ...
        public RelationalProviderTestProxy(string scopeName, string serviceURL)
        {
            this.scopeName = scopeName;
            this.serviceURL = serviceURL;
            CreateProxy();
            _proxy.Initialize(scopeName);
        }
        ...
        {
            var wrapper = _proxy.GetKnowledge();
        ...
        {
            return _proxy.GetScopeDescription();
        }

        ~RelationalProviderTestProxy()
        {
            Dispose(false);
        }
