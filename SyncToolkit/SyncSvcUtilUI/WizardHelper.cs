...
namespace SyncSvcUtilUI
{
    internal class WizardHelper
    {
        ...
        public const string SELECT_TABLENAMES_QUERY =
        ...
        public const string CODEGEN_COMMON_PARAMS_FORMAT =
            "/language:{0} /namespace:{1} /mode:codegen /target:{2} /directory:{3}";

        public const string CODEGEN_OUTPREFIX_PARAM_FORMAT = "{0} /outprefix:{1}";
        public const string CSDL_CODEGEN_URL_FORMAT = "{0}";
        private static WizardHelper _instance;

        public static string[] SYNC_TABLE_NAMES =
        {
            "schema_info", "scope_info", "scope_config", "scope_templates",
            "scope_parameters"
        };
