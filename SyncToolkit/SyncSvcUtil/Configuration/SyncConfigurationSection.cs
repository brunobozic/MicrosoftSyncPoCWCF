...
namespace Microsoft.Synchronization.ClientServices.Configuration
{
    ...
    public class SyncConfigurationSection : ConfigurationSection, ICloneable
    {
        ...
        public SyncScopeCollection SyncScopes
        {
            get
            {
                var collection = (SyncScopeCollection) base["SyncScopes"];
                return collection;
            }
        }
        ...
        public TargetDatabaseCollection Databases
        {
            get
            {
                var collection = (TargetDatabaseCollection) base["Databases"];
                return collection;
            }
        }
        ...
        {
            return SerializeSection(this, "SyncConfiguration", ConfigurationSaveMode.Full);
        }
    }
}