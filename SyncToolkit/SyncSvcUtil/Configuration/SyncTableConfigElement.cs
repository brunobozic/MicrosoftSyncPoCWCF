...
namespace Microsoft.Synchronization.ClientServices.Configuration
{
    ...
    ///     <SyncTable Name="[DatabaseName]" GlobalName="[Global Name]" SchemaName="[Schema name]"
    ///         IncludeAllColumns="true|false" FilterClause="[Filter clause]" />
    /// </summary>
    public class SyncTableConfigElement : ConfigurationElement, ICloneable
    {
        ...
        public string GlobalName
        {
            get
            {
                var gName = (string) this["GlobalName"];
                if (string.IsNullOrEmpty(gName))
                {
                    return CodeDomUtility.SanitizeName(Name);
                }
        ...
        {
            get { return (bool) this["IncludeAllColumns"]; }
            set { this["IncludeAllColumns"] = value; }
        }
        ...
        {
            get { return (string) this["FilterClause"]; }
            set
            {
                if (value == null)
                {
        ...
        public SyncColumnCollection SyncColumns
        {
            get
            {
                var collection = (SyncColumnCollection) base["SyncColumns"];
                return collection;
            }
        }
        ...
        public FilterColumnCollection FilterColumns
        {
            get
            {
                var collection = (FilterColumnCollection) base["FilterColumns"];
                return collection;
            }
        }
        ...
        public FilterParameterCollection FilterParameters
        {
            get
            {
                var collection = (FilterParameterCollection) base["FilterParameters"];
                return collection;
            }
        }
