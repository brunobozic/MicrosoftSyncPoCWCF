...
namespace Microsoft.Synchronization.ClientServices.Configuration
{
    ...
    public class SyncScopeConfigElement : ConfigurationElement, ICloneable
    {
        ...
        {
            get { return (bool) this["IsTemplateScope"]; }
            set { this["IsTemplateScope"] = value; }
        }
        ...
        {
            get { return (bool) this["EnableBulkApplyProcedures"]; }
            set { this["EnableBulkApplyProcedures"] = value; }
        }
        ...
        public SyncTableCollection SyncTables
        {
            get
            {
                var collection = (SyncTableCollection) base["SyncTables"];
                return collection;
            }
        }
        ...
        public object Clone()
        {
            var config = new SyncScopeConfigElement
            {
                Name = Name,
                IsTemplateScope = IsTemplateScope,
                EnableBulkApplyProcedures = EnableBulkApplyProcedures
            };
