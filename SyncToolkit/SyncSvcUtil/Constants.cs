...
namespace Microsoft.Synchronization.ClientServices
{
    ...
    internal class Constants
    {
        ...
        public const string ServiceSyncScopeAttributeDefinition =
        ...
        public const string ServiceSyncColumnMappingAttribute =
            "Microsoft.Synchronization.Services.SyncEntityPropertyMappingAttribute";

        public const string ServiceISyncSvcConfigurationType =
            "Microsoft.Synchronization.Services.ISyncServiceConfiguration";

        public static string[] ServiceSyncSvcCommentLines =
        {
        ...
        public static string[] ServiceSyncSvcPreSchemaCommentLines =
        {
            string.Empty,
            string.Empty,
        ...
        public const string ServiceSyncServicSVCFileContents =
            "<%@ ServiceHost Language=\"{0}\" Service=\"{1}.{2}\" CodeBehind=\"{3}\" Factory=\"Microsoft.Synchronization.Services.SyncServiceHostFactory, Microsoft.Synchronization.Services, Version={4}, Culture=neutral\" %>";

        public const string ServiceOfflineEntityMetadataTypeName =
            "Microsoft.Synchronization.Services.OfflineEntityMetadata";

        public const string EntityPropertyNullableAttributeType =
        ...
        public const string ClientContextBaseType =
            "Microsoft.Synchronization.ClientServices.IsolatedStorage.IsolatedStorageOfflineContext";

        public const string ClientSchemaBaseType =
            "Microsoft.Synchronization.ClientServices.IsolatedStorage.IsolatedStorageSchema";
        ...
        public const string ClientIsolatedStoreOfflineEntity =
            "Microsoft.Synchronization.ClientServices.IsolatedStorage.IsolatedStorageOfflineEntity";
        ...
        public const string ClientOfflineEntityMetadataTypeName =
            "Microsoft.Synchronization.ClientServices.OfflineEntityMetadata";
