...
{
    internal class EntityGeneratorFactory
    {
        /// <summary>
        ///     Create a new instance of EntityGenerator implementation.
        /// </summary>
        /// <param name="target">Target for which to generate code.</param>
        /// <param name="syncObjectSchema">
        ///     Schema under which the sync related objects are created in the SQL database.
        ///     This can be null when generating non-server code.
        /// </param>
        /// <returns></returns>
